...
| 模板 | 系统提示词文件 | 默认状态 |
|------|---------------|---------|
| Query 增强 | `prompts/query_enhance.md` | 启用 |
| 剧情编排 | `prompts/plot_director.md` | 禁用 |
| 描写增强 | `prompts/description.md` | 禁用 |
...
| 文件 | 职责 |
|------|------|
| `services/preprocessing/Preprocessor.ts` | 预处理核心逻辑 |
| `services/preprocessing/OutputParser.ts` | 输出解析 (Regex 捕获) |
| `services/preprocessing/types.ts` | 类型定义 |
| `services/rag/Injector.ts` | 事件监听和注入 |
| `services/api/prompts/query_enhance.md` | Query 增强系统提示词 |
| `services/api/prompts/plot_director.md` | 剧情编排系统提示词 |
| `services/api/prompts/description.md` | 描写增强系统提示词 |
| `services/api/types.ts` | 模板定义和分类 |
